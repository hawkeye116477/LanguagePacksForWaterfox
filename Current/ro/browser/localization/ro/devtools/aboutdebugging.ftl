...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Activează depanarea USB în Waterfox pe dispozitivul Android.
# USB section step by step guide
...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Este posibil ca panoul de depanare să nu funcționeze în browserul conectat. Te rugăm să folosești Waterfox { $runtimeVersion } dacă trebuie să folosești Depanatorul în acest browser.
