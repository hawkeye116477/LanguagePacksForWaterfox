...
rights-intro-point-1 = { -brand-short-name } on tehtud kättesaadavaks järgneva litsentsi all: <a data-l10n-name="mozilla-public-license-link">Waterfox avalik litsents (MPL - Mozilla Public License)</a>. See tähendab, et sa võid { -brand-short-name }i kasutada, kopeerida ja teistele jagada. Sa võid ka igati muuta { -brand-short-name }i lähtekoodi, kui tahad, et see paremini sobiks sinu vajadustega. Samuti annab Waterfox avalik litsents (MPL) sulle õiguse oma muudetud versiooni edasi levitada.
rights-intro-point-2 = Waterfox ei anna sulle mingeid õigusi ega litsentse Waterfox ja Waterfoxi kaubamärkide või logode üle. Lisainfot kaubamärkide kohta võib leida <a data-l10n-name="mozilla-trademarks-link">siit</a>.
