...
enable-about-debugging-message = S nástroji pro vývojáře můžete ve Waterfoxu vyvíjet a ladit doplňky, WebExtensions, web a service workers a další.
...
enable-common-message = Nástroje pro vývojáře jsou ve výchozím stavu ve Waterfoxu vypnuty pro vaši větší kontrolu nad funkcemi prohlížeče.
...
footer-message = Hledáte více než jenom nástroje pro vývojáře? Vyzkoušejte verzi Waterfoxu speciálně pro vývojáře a jejich pracovní postupy.
