...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Panel Debugger mungkin tidak berfungsi dengan peramban yang tersambung. Gunakan Waterfox { $runtimeVersion } jika Anda perlu menggunakan Debugger dengan peramban ini.
