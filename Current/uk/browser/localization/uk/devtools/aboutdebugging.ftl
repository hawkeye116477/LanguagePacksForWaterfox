...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Увімкніть зневадження через USB в Waterfox на пристрої Android.
# USB section step by step guide
...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Панель зневадження може не працювати з під'єднаним браузером. Будь ласка, використовуйте Waterfox { $runtimeVersion }, якщо вам необхідно використовувати зневаджувач з цим браузером.
...
about-debugging-browser-version-too-recent = Під'єднаний браузер є більш новим ({ $runtimeVersion }, buildID { $runtimeID }), ніж ваш { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Ця конфігурація не підтримується і може призвести до збою DevTools. Будь ласка, оновіть Waterfox. <a>Вирішення проблем</a>
