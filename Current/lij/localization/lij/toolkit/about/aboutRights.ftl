...
rights-intro-point-1 = { -brand-short-name } te vegne dæto sotta a-i termini da <a data-l10n-name="mozilla-public-license-link">Licensa Pubrica de Waterfox</a>. Questo o veu dî che ti ti peu deuviâ, copiâ e distriboî o { -brand-short-name } a-i atri. Ti ê o benvegnuo anche a cangiâ i sorgenti de { -brand-short-name } pe-i teu bezeugni. A Licensa Pubrica de Waterfox a te dâ anche o dirito de distriboî e teu verscioin modificæ.
rights-intro-point-2 = Waterfox no te dâ di diriti in sci marchi e lòghi de Waterfox e Waterfox. Atre informaçioin in sci marchi e lòghi se peuan atrovâ <a data-l10n-name="mozilla-trademarks-link">chi</a>.
