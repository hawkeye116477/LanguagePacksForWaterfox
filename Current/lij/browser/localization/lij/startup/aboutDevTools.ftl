...
newsletter-title = Newsletter di Svilupatoî Waterfox
newsletter-message = Piggite e notiçie di svilupatoî e risorse mandæ pròprio inta teu cazella de pòsta.
newsletter-email-placeholder =
    .placeholder = Email
newsletter-privacy-label = Son d'acòrdio che Waterfox o manezze e mæ informaçioin comme spiegou inta <a data-l10n-name="privacy-policy">Politica da Privacy</a>.
newsletter-subscribe-button = Abon-ite
newsletter-thanks-title = Graçie!
newsletter-thanks-message = Se primma no ti æ confermou l'abonamento a-a newsletter in sce Waterfox ti doviesci fâlo. Amîa ben inta teu pòsta in intrâ ò into spam se no ti gh'æ ina email da niâtri.
