...
changed-desc-dedicated = כדי להקל על המעבר בין התקנות של Waterfox (לרבות Waterfox,‏ Waterfox ESR,‏ Waterfox Beta,‏ Waterfox Developer Edition ו־Waterfox Nightly), התקנה זו כוללת מעתה פרופיל ייעודי שלא ישתף את פרטיך עם התקנות אחרות של Waterfox באופן אוטומטי.
lost = <b>לא איבדת שום נתונים אישיים או התאמות אישיות.</b> אם כבר שמרת מידע ב־Waterfox במחשב זה, הוא עדיין זמין בהתקנה אחרת של Waterfox.
