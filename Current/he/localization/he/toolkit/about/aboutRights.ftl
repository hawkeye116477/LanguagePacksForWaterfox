...
rights-intro-point-1 = { -brand-short-name } ניתן לך תחת התנאים של <a data-l10n-name="mozilla-public-license-link">הרישיון הציבורי של Waterfox</a>. משמעות הדבר היא שניתן להשתמש ב־{ -brand-short-name }, להעתיקו ולהפיצו לאחרים, כמו גם לשנות את קוד המקור של { -brand-short-name } בדרך המתאימה ביותר לצרכיך. הרישיון הציבורי של Waterfox גם נותן לך את הזכות להפיץ את הגרסאות עם השינויים שלך.
rights-intro-point-2 = לא הוענקה לך אף זכות בסמל המסחרי או רישיונות לסמל המסחרי של קרן Waterfox או חלקן, לא כולל הגבלה על השם או הלוגו של Waterfox. מידע נוסף על הסמלים המסחריים נמצא <a data-l10n-name="mozilla-trademarks-link">כאן</a>.
