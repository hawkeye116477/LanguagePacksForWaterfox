...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox = Enable USB Debugging in Waterfox on the Android device. <a>Learn how</a>
# USB section step by step guide
...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = The Debugger panel may not work with the connected browser. Please use Waterfox { $runtimeVersion } if you need to use the Debugger with this browser.
