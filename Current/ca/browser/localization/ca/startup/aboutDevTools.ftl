...
enable-title = Activa les eines per a desenvolupadors del Waterfox
...
welcome-title = Us donem la benvinguda a les eines per a desenvolupadors del Waterfox!
newsletter-title = Butlletí de desenvolupadors de Waterfox
newsletter-email-placeholder =
    .placeholder = Adreça electrònica
newsletter-privacy-label = Accepto que Waterfox gestioni la meva informació en els termes descrits en la <a data-l10n-name="privacy-policy">política de privadesa</a>.
newsletter-subscribe-button = Subscriu-m'hi
newsletter-thanks-title = Gràcies!
newsletter-thanks-message = Si anteriorment no heu confirmat la subscripció a algun butlletí de notícies relacionat amb Waterfox, és possible que ho hàgiu de fer. Comproveu la safata d'entrada o el filtre de correu brossa per veure si hi ha algun missatge de Waterfox.
