...
enable-title = Waterfox 개발자 도구 활성화
enable-inspect-element-title = 요소 검사를 사용하기 위해 Waterfox 개발자 도구 활성화하기
enable-inspect-element-message = 개발자 도구의 검사기로 HTML과 CSS를 검사하고 편집하세요.
enable-about-debugging-message = Waterfox 개발자 도구로 WebExtensions이나 웹 워커, 서비스 워커 등을 개발하고 디버깅하세요.
...
enable-common-message = Waterfox 개발자 도구는 브라우저를 보다 강력하게 제어 할 수 있도록 기본적으로 비활성화되어 있습니다.
enable-learn-more-link = 개발자 도구에 대하여 자세히 알아보기
enable-enable-button = 개발자 도구 활성화
enable-close-button = 이 탭 닫기
welcome-title = Waterfox 개발자 도구에 오신 것을 환영합니다!
newsletter-title = Waterfox 개발자 뉴스레터
newsletter-message = 개발자 뉴스와 기법, 자료를 받은 편지함으로 바로 보내세요.
newsletter-email-placeholder =
    .placeholder = 이메일
newsletter-privacy-label = 전 Waterfox에서 제 정보를 이 <a data-l10n-name="privacy-policy">개인 정보 정책</a>에 나와있는 대로 다뤄도 괜찮습니다.
newsletter-subscribe-button = 구독
newsletter-thanks-title = 고맙습니다!
newsletter-thanks-message = 만약 이전에 Waterfox 관련 뉴스 레터 구독을 확인하지 않았다면 그렇게해야 할 수 있습니다. 받은 편지함이나 스팸 필터에서 이메일을 확인하세요.
footer-title = Waterfox 개발자 버전
footer-message = 더 좋은 개발자 도구를 찾고 계신가요? 개발자와 현대적인 워크플로우를 위해 특별히 제작된 Waterfox 브라우저를 확인해보세요.
