...
about-telemetry-firefox-data-doc = <a data-l10n-name="data-doc-link">Waterfox Data Documentation</a>에 데이터 도구를 다루는 방법이 나와 있습니다.
about-telemetry-telemetry-client-doc = <a data-l10n-name="client-doc-link">Waterfox Telemetry client documentation</a>에 개요와 API 문서, 데이터 참조가 포함되어 있습니다.
about-telemetry-telemetry-dashboard = <a data-l10n-name="dashboard-link">Telemetry dashboards</a>를 이용하여 Telemetry를 통해 Waterfox가 수신한 데이터를 시각화 할 수 있습니다.
