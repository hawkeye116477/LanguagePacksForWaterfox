...
newsletter-title = Surat Berita Pembangun Waterfox
newsletter-message = Dapatkan berita. helah dan sumber yang dihantar terus ke peti masuk anda.
newsletter-email-placeholder =
    .placeholder = E-mel
newsletter-privacy-label = Saya setuju Waterfox mengendalikan maklumat saya seperti yang dijelaskan dalam <a data-l10n-name="privacy-policy">Polisi Privasi ini</a>.
newsletter-subscribe-button = Langgan
newsletter-thanks-title = Terima kasih!
newsletter-thanks-message = Jika anda belum pernah mengesahkan langganan surat berita yang berkaitan dengan Waterfox, anda mungkin perlu untuk berbuat demikian. Sila semak peti masuk anda atau penapis spam anda untuk dapatkan e-mel daripada kami.
