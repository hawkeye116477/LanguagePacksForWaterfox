...
onboarding-fxa-text = Prihláste sa ku svojmu účtu Waterfox a synchronizujte svoje záložky, heslá a otvorené karty kdekoľvek používate aplikáciu { -brand-short-name }.
