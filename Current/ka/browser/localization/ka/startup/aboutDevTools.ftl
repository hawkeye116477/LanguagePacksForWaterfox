...
enable-about-debugging-message = შეიმუშავეთ და გამართეთ WebExtensions (გაფართოებების), WebWorkers (მრავალამოცანიანი), ServiceWorkers (ფონურად დასამუშავებელი) და სხვა სახის სკრიპტები, Waterfox-ის შემმუშავებლის ხელსაწყოებით.
...
enable-common-message = Waterfox-ის შემმუშავებლის ხელსაწყოები, ნაგულისხმევად გამორთულია, რომ ბრაუზერის მართვის სადავეები, სრულად თქვენს ხელში იყოს.
...
welcome-title = მოგესალმებით, Waterfox-ის შემმუშავებლის ხელსაწყოების გვერდზე!
newsletter-title = Waterfox-ს სიახლეები და ცნობები შემმუშავებლებისთვის
...
newsletter-email-placeholder =
    .placeholder = ელფოსტა
newsletter-privacy-label = თანახმა ვარ, რომ Waterfox-მ ჩემი მონაცემები გამოიყენოს, <a data-l10n-name="privacy-policy">პირადულობის დაცვის დებულების</a> შესაბამისად.
newsletter-subscribe-button = გამოწერა
newsletter-thanks-title = გმადლობთ!
newsletter-thanks-message = თუ ჯერ არ დაგიმოწმებიათ Waterfox-ს საინფორმაციო ცნობების გამოწერა, ამის გაკეთება ახლაც შეგიძლიათ. გთხოვთ, მონახოთ ჩვენი გზავნილი მიღებული წერილების ან სპამის საქაღალდეში.
footer-title = Waterfox Developer Edition
footer-message = გსურთ მეტი, ვიდრე შემმუშავებლის ხელსაწყოებია? იხილეთ Waterfox ბრაუზერი, შექმნილი საგანგებოდ შემმუშავებლებისთვის და განკუთვნილი, თანამედროვე სამუშაო პირობებისთვის.
