...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Aktivigi senerarigon USB en Waterfox en via aparato Android.
# USB section step by step guide
...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = La panelo de la erarserĉilo povus ne funkcii kun la konektita retumilo. Bonvolu uzi Waterfox { $runtimeVersion } se vi bezonas uzi la erarserĉilon kun tiu ĉi retumilo.
...
about-debugging-browser-version-too-recent = La konektita retumilo estas pli nova ({ $runtimeVersion }, buildID { $runtimeID }) ol via { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Tiu ĉi estas nesubtenata situacio, kiu povus misfunkciigi la ilojn por programistoj. Bonvolu ĝisdatigi Waterfox. <a>Solvado de problemoj</a>
