...
enable-title = Attivazione strumenti di sviluppo di Waterfox
enable-inspect-element-title = Attiva gli strumenti di sviluppo di Waterfox per utilizzare “Analizza elemento”
enable-inspect-element-message = Analizza e modifica HTML e CSS con Analisi pagina.
enable-about-debugging-message = Sviluppa ed effettua il debug di WebExtension, web worker, service worker e altro ancora con gli strumenti di sviluppo di Waterfox.
...
enable-common-message = Gli strumenti di sviluppo di Waterfox sono disattivati per impostazione predefinita, garantendo agli utenti il pieno controllo del proprio browser.
...
welcome-title = Benvenuto negli strumenti di sviluppo di Waterfox
newsletter-title = Newsletter Waterfox dedicata agli sviluppatori
newsletter-message = Ricevi notizie, suggerimenti e risorse sullo sviluppo web direttamente nella tua casella di posta.
newsletter-email-placeholder =
    .placeholder = Email
newsletter-privacy-label = Acconsento al trattamento dei dati da parte di Waterfox secondo quanto indicato nell’<a data-l10n-name="privacy-policy">informativa sulla privacy</a>.
newsletter-subscribe-button = Iscrivimi
newsletter-thanks-title = Grazie!
newsletter-thanks-message = Potrebbe essere necessario confermare l’iscrizione se non sei già iscritto a una newsletter Waterfox. Verifica se c’è un nostro messaggio nella posta in arrivo o nello spam.
footer-title = Waterfox Developer Edition
footer-message = Hai bisogno di qualcosa in più rispetto ai soli strumenti di sviluppo? Dai un’occhiata alla versione di Waterfox realizzata appositamente per sviluppatori e flussi di lavoro all’avanguardia.
