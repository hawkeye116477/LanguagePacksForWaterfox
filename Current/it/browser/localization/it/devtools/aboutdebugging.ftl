...
about-debugging-browser-version-too-old-67-debugger = Il pannello Debugger potrebbe non funzionare correttamente con il browser connesso. Utilizzare Waterfox { $runtimeVersion } per gestire il Debugger con questo browser.
