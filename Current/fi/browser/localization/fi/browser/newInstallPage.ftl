...
changed-desc-profiles = Tällä { -brand-short-name }-asennuksella on uusi profiili. Profiili on joukko tiedostoja, johon Waterfox tallentaa muun muassa kirjanmerkit, salasanat ja käyttäjän asetukset.
...
lost = <b>Et ole menettänyt henkilökohtaisia tietoja tai mukautuksia.</b> Jos olet jo tallentanut tietoja Waterfoxiin tällä tietokoneella, tietosi ovat edelleen saavutettavissa toisesta Waterfox-asennuksesta.
