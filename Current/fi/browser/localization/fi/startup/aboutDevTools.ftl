...
newsletter-privacy-label = Minulle sopii, että Waterfox käsittelee tietojani <a data-l10n-name="privacy-policy">tietosuojaselosteen</a> mukaisesti.
newsletter-subscribe-button = Tilaa
newsletter-thanks-title = Kiitos!
newsletter-thanks-message = Voit joutua vahvistamaan tilauksen, jos et ole aiemmin vahvistanut Waterfoxan liittyvän uutiskirjeen tilausta. Tarkista sähköpostisi ja roskapostisuodattimesi viestimme varalta.
