...
separate-profile-mode =
    .label = Permitir a { -brand-short-name } y Waterfox ejecutarse al mismo tiempo
...
home-mode-choice-default =
    .label = Inicio de Waterfox (por defecto)
...
sync-mobile-promo = Descarga Waterfox para <img data-l10n-name="android-icon"/> <a data-l10n-name="android-link">Android</a> o <img data-l10n-name="ios-icon"/> <a data-l10n-name="ios-link">iOS</a> para sincronizar con tu dispositivo móvil.
