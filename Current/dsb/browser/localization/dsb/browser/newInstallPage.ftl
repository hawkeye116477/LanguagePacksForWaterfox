...
changed-desc-profiles = Toś ta instalacija { -brand-short-name } ma nowy profil. Profil jo sajźba datajow, źož Waterfox informacije ako cytańske znamjenja, gronidła a wužywarske nastajenja składujo.
changed-desc-dedicated = Aby se pśešaltowanje mjazy instalacijami Waterfox (Waterfox, Waterfox ESR, Waterfox Beta, Waterfox Developer Edition a Waterfox Nightly) wólažcyło a wěsćej cyniło, ma toś ta instalacija něnto swójski pśisłušny profil. Njeźěli awtomatiski waše skłaźone informacije z drugimi instalacijami Waterfox.
