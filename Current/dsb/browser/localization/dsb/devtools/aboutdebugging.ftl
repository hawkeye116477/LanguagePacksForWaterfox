...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Pytanje zmólkow USB w Waterfox na rěźe Android zmóžniś.
# USB section step by step guide
...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Pólo pytanja zmólkow snaź ze zwězanym wobglědowakom njefunkcioněrujo. Pšosym wužywajśo Waterfox { $runtimeVersion }, jolic musyśo pytanje zmólkow z toś tym wobglědowakom wužywaś.
...
about-debugging-browser-version-too-recent = Zwězany wobglědowak jo aktualnjejšy ({ $runtimeVersion }, buildID { $runtimeID }) lěc waš { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). To jo njepódpěrana konfiguracija a móžo zawinowaś, až wuwijarske rědy njefunkcioněruju. Pšosym aktualizěrujśo Waterfox. <a>Rozwězanje problemow</a>
