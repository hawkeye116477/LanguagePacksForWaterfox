...
newsletter-title = Әзірлеушілерге арналған Waterfox жаңалықтар таратуы
...
newsletter-privacy-label = Мен Waterfox-ның менің ақпаратымды мына <a data-l10n-name="privacy-policy">Құпиялылық саясатында</a> көрсетілгендей өңдейтінімен келісемін.
