...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Android құрылғыңыздағы Waterfox ішінде USB жөндеуін іске қосыңыз.
# USB section step by step guide
...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Жөндеуші панелі байланысқан браузермен жұмыс жасамауы мүмкін. Бұл браузермен Жөндеушіні қолданам десеңіз, кем дегенде Waterfox { $runtimeVersion } қолданыңыз.
