...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = O painel Depurador pode não funcionar com o navegador ligado. Por favor utilize o Waterfox { $runtimeVersion } se precisar de utilizar o Depurador com este navegador.
