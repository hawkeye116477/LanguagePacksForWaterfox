...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Панэль адладчыка не можа працаваць з падлучаным браўзерам. Калі ласка, выкарыстоўвайце Waterfox { $runtimeVersion }, калі вам трэба выкарыстоўваць адладчык з гэтым браўзерам.
