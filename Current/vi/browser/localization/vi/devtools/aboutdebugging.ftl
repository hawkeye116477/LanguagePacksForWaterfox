...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Bảng trình gỡ lỗi có thể không hoạt động với trình duyệt được kết nối. Vui lòng sử dụng Waterfox { $runtimeVersion } nếu bạn cần sử dụng trình gỡ lỗi với trình duyệt này.
