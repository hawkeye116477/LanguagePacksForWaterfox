...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Het Debugger-paneel werkt mogelijk niet met de verbonden browser. Gebruik Waterfox { $runtimeVersion } als u de Debugger met deze browser moet gebruiken.
