...
fxa-qrcode-heading-phase1 = 1. Falls Sie es noch nicht durchgeführt haben, so installieren Sie <a data-l10n-name="connect-another-device">Waterfox auf einem Mobilgerät</a>.
