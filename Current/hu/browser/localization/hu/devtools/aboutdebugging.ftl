...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = A Hibakereső panel lehet hogy nem fog működni a csatlakoztatott böngészővel. Használja a Waterfox { $runtimeVersion } verziót, ha ezzel a böngészővel akarja használni a Hibakeresőt.
