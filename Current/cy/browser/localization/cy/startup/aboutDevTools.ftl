...
newsletter-email-placeholder =
    .placeholder = E-bost
newsletter-privacy-label = Rwy'n fodlon i Waterfox drin fy manylion fel mae'n cael ei esbonio yn <a data-l10n-name="privacy-policy">y Polisi Preifatrwydd hwn</a>.
newsletter-subscribe-button = Tanysgrifio
newsletter-thanks-title = Diolch!
newsletter-thanks-message = Os nad ydych eisoes wedi cadarnhau tanysgrifiad i gylchlythyr yn perthyn i Waterfox, mae'n bosib y bydd yn rhaid i chi wneud hynny. Gwiriwch eich blwch derbyn neu eich hidl sbam am e-bost gennym ni.
