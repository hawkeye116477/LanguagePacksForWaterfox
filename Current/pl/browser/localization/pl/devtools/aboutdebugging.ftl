...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Włącz debugowanie przez USB w Waterfoksie na urządzeniu z Androidem.
# USB section step by step guide
...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Panel debugera może nie działać z połączoną przeglądarką. Proszę użyć Waterfoksa { $runtimeVersion }, jeśli debuger musi być używany z tą przeglądarką.
