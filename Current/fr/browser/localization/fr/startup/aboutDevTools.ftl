...
enable-title = Activer les outils de développement de Waterfox
enable-inspect-element-title = Activez les outils de développement de Waterfox pour utiliser Examiner l’élément
...
enable-about-debugging-message = Développez et déboguez des WebExtensions, des web workers, des service workers et bien plus grâce aux outils de développement de Waterfox.
...
enable-common-message = Les outils de développement de Waterfox sont désactivés par défaut afin de vous permettre de contrôler davantage votre navigateur.
...
welcome-title = Bienvenue dans les outils de développement de Waterfox !
newsletter-title = Lettre d’information de Waterfox pour les développeurs
...
newsletter-privacy-label = J’accepte que Waterfox utilise mes informations conformément à <a data-l10n-name="privacy-policy">cette politique de confidentialité</a>.
newsletter-subscribe-button = S’abonner
newsletter-thanks-title = Merci !
newsletter-thanks-message = Si vous n’avez jamais confirmé d’abonnement à une lettre d’information liée à Waterfox, vous devrez peut-être le faire. Veuillez vérifier votre boîte de réception ou vos courriers indésirables et recherchez un message de notre part.
footer-title = Waterfox Developer Edition
footer-message = Vous recherchez davantage que des outils de développement ? Découvrez le navigateur Waterfox conçu spécifiquement pour les développeurs et les flux de travail modernes.
