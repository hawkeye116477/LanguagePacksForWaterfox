...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Le panneau du débogueur risque de ne pas fonctionner avec le navigateur connecté. Veuillez utiliser Waterfox { $runtimeVersion } si vous avez besoin d’utiliser le débogueur avec ce navigateur.
