...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Es posible que el panel del depurador no funcione con el tiempo de ejecución conectado. Utilice Waterfox { $runtimeVersion }{ $runtimeVersion } si necesita usar el depurador con este navegador.
