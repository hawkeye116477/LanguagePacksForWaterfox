...
newsletter-email-placeholder =
    .placeholder = E-mail
newsletter-privacy-label = Jau sun d'accord che Waterfox tracta mias datas tenor questas <a data-l10n-name="privacy-policy">reglas da la protecziun da datas</a>.
newsletter-subscribe-button = Abunar
newsletter-thanks-title = Grazia!
newsletter-thanks-message = Sche ti n'has anc mai abunà in newsletter da Waterfox, stos ti confermar l'abunament. Controllescha per plaschair sche tia posta entrada u tes filter da posta nungiavischada cuntegnia in e-mail da nus.
