...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Rmed tamseɣtayt USB def Waterfox deg yibenk-ik android.
# USB section step by step guide
...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Agalis n temseɣtayt tezmer ur tetteddu ara s yiminig yeqqnen. Ma ulac aɣilif, seqde Waterfox { $runtimeVersion } ma teḥwaǧeḍ ad tesqedceḍ tamseqtayt s yiminig-a.
