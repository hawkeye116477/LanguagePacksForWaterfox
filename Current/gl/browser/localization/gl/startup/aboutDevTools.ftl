...
newsletter-title = Boletín de información para desenvolvedores de Waterfox
...
newsletter-privacy-label = Acepto que Waterfox use a miña información como se explican nesta <a data-l10n-name="privacy-policy">política de privacidade</a>.
newsletter-subscribe-button = Subscribirse
newsletter-thanks-title = Grazas!
newsletter-thanks-message = Se previamente non confirmou unha subscrición a un boletín relacionado con Waterfox, pode ter que facelo agora. Comprobe a súa caixa de entrada ou o seu filtro de correo lixo para atopar un correo noso.
