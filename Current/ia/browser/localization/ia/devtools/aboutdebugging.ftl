...
# USB section step by step guide
about-debugging-setup-usb-step-enable-debug-firefox2 = Activar le recerca de errores USB in Waterfox sur le dispositivo Android.
# USB section step by step guide
...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Le quadro del Depurator non pote laborar con le navigator connexe. Usa Waterfox { $runtimeVersion } si tu debe usar le Depurator con iste navigator.
...
about-debugging-browser-version-too-recent = Le navigator connexe es plus recente ({ $runtimeVersion }, buildID { $runtimeID }) que tu { -brand-shorter-name } ({ $localVersion }, buildID { $localID }). Isto es un installation non supportate e pote facer faller DevTools. Actualisa Waterfox. <a>Resolution de problemas</a>
