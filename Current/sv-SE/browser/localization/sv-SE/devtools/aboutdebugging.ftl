...
# { $runtimeVersion } is the version of the remote browser (for instance "67.0a1")
about-debugging-browser-version-too-old-67-debugger = Felsökningspanelen kanske inte fungerar med den anslutna webbläsaren. Vänligen använd Waterfox { $runtimeVersion } om du behöver använda felsökaren med den här webbläsaren.
